...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--model',
        help='Type of model. Supported types are Linear, DNN, CNN, RNN, LSTM',
        required=True
    )
    ...
    parser.add_argument(
        '--seq_length',
        help="This model works with fixed length sequences. First N are inputs, rest are output",
        type=int,
        required=True
    )
    ...
    parser.add_argument(
        '--n_forward',
        help="This model works with fixed length sequences. 1-(N-1) are inputs, last is output",
        type=int,
        required=True
    )
